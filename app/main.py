...
from app.api.routes import accounts, cases, companies, discovery, health, portals, provenance, requests, responses
...
def create_app() -> FastAPI:
    ...
    async def configured_token_auth(request: Request, call_next):
        ...
        if settings.privacy_api_token and request.url.path != "/health":
